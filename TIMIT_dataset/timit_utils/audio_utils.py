...
def audio_features(data: np.ndarray, sample_rate: int, window_length: float, window_step: float, 
                    nfilt: int, feature_types: List[int] = AudioFeaturesMelAll) -> np.ndarray:
